...
namespace SalesMVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(BDSALESContext context)
        {
            _context = context;
        }
        ...
        {
            var clientes = from customer in _context.Customers select customer;
            ...
            switch (filtro)
            {
                case "NombreDescendente":
                    clientes=clientes.OrderByDescending(cliente=>cliente.FirstName);
                    break;
                case "ApellidoDescendente":
                    clientes = clientes.OrderByDescending(cliente => cliente.LastName);
                    break;
                    //se va a ordenar por insercion de manera ascendente
                default:
                    clientes=clientes.OrderBy(cliente=>cliente.CustomerId);
                    break;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BDSALESContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
